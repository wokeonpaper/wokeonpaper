...
new_stories = r'''
  {
    ...
    tag: "Work Culture",
    cover: "/wokeonpaper/stories/paid-cover.png",
    images: ["/wokeonpaper/stories/paid-support.png"],
  ...
  },
  {
    ...
    tag: "Accountability",
    cover: "/wokeonpaper/stories/report-cover.png",
    author: "Social Sector Majdoor Union",
    authorHandle: "wokeonpaper",
    readTime: "5 min read",
    sections: [
  ...
  },
  {
    ...
    tag: "Power & Politics",
    cover: "/wokeonpaper/stories/fcra-cover.png",
    author: "Social Sector Majdoor Union",
    authorHandle: "wokeonpaper",
    readTime: "8 min read",
    sections: [
  ...
  },
  {
    ...
    tag: "Power & Politics",
    cover: "/wokeonpaper/stories/ncert-cover.png",
    author: "Social Sector Majdoor Union",
    authorHandle: "wokeonpaper",
    readTime: "7 min read",
    sections: [
  ...
  },
  {
    ...
    tag: "Power & Politics",
    cover: "/wokeonpaper/stories/narratives-cover.png",
    images: ["/wokeonpaper/stories/narratives-support.png"],
    author: "Social Sector Majdoor Union",
    authorHandle: "wokeonpaper",
    readTime: "5 min read",
    sections: [
  ...
  },
  {
    ...
    tag: "Funding",
    cover: "/wokeonpaper/stories/dba-cover.png",
    images: ["/wokeonpaper/stories/dba-support.png"],
    author: "Social Sector Majdoor Union",
    authorHandle: "wokeonpaper",
    readTime: "4 min read",
    sections: [
  ...
  },
  {
    ...
    tag: "Power & Knowledge",
    cover: "/wokeonpaper/stories/academic-cover.png",
    images: ["/wokeonpaper/stories/academic-support.png"],
    author: "Social Sector Majdoor Union",
    authorHandle: "wokeonpaper",
    readTime: "5 min read",
    sections: [
...
# Find the final "]" that closes the stories array (the last "]" in file)
idx = t.rstrip().rfind("]")
if idx == -1:
    raise SystemExit("Could not find closing bracket of stories array")

before = t[:idx].rstrip()
# Ensure it ends with a comma after the last story object
if not before.endswith(","):
    before += ","

new_text = before + "\n" + new_stories.rstrip() + "\n]\n"
p.write_text(new_text)
print("Added 7 new stories. File now has", new_text.count("slug:"), "stories total.")
